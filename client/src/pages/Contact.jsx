            ...
            <div className="mt-6 mx-4 sm:mt-8 flex flex-col sm:flex-row items-center gap-3">
              <div className="w-full sm:flex-1">
                <label htmlFor="email" className="flex items-center w-full bg-gray-200 rounded-[15px] px-3 py-2 sm:py-3 text-base">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="mr-3 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                    <path d="M3 8.5L12 13L21 8.5" stroke="#111827" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
                    <rect x="3" y="5" width="18" height="14" rx="4" stroke="#111827" strokeWidth="1.2" />
                  </svg>
              ...
              <button className="w-full sm:w-auto rounded-[15px] px-6 py-2.5 sm:py-3 bg-[#2b82ff] hover:bg-[#206edf] transition text-white font-semibold shadow-md cursor-pointer">Subscribe</button>
            </div>

            <p className="mt-4 sm:mt-6 text-xs sm:text-sm text-gray-400">By subscribing, you agree with Lessonly Terms of Service and Privacy Policy.</p>
          </div>
        </section>
      </main>
